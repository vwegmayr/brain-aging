...
def prepare_file_system():
  ...
  if tf.gfile.Exists(FLAGS.summaries_dir):
    print('[FATAL] Directory %s already exists' % FLAGS.summaries_dir)
    exit(0)
...
def main(_):
  ...
  tf.logging.warning('Summaries directory: %s' % FLAGS.summaries_dir)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/tmp/retrain_logs', # /local/dhaziza/data/
