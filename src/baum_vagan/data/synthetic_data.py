...
from src.baum_vagan.data import synthetic_data_loader
from src.baum_vagan.data.batch_provider import BatchProvider
...
class synthetic_data():
    ...
    def __init__(self, exp_config):
        ...
        images_train_and_val, images_test, labels_train_and_val, labels_test, _ ,gts_test = train_test_split(images, labels, gts, test_size=0.2,  stratify=labels, random_state=42)
        images_train, images_val, labels_train, labels_val = train_test_split(images_train_and_val, labels_train_and_val, test_size=0.2, stratify=labels_train_and_val, random_state=42)
